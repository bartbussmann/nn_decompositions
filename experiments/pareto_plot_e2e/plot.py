"""Plot the end-to-end Pareto figure from `pareto_plot_e2e.py`'s output JSON.
...
Usage:
    python experiments/pareto_plot_e2e/plot.py
    python experiments/pareto_plot_e2e/plot.py --dict_sizes 4k
"""
